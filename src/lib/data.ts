// Ported verbatim from design_handoff_farm_dashboard/seed-data.js.
// This is placeholder/static content standing in for the Supabase tables
// described in the README's "Data model" section — every table there
// (people, tasks, posts, log_entries, metrics_snapshots, library_items, …)
// should eventually replace the corresponding constant below. Content notes
// and confirmed-vs-placeholder status are documented in README.md.
...
export const NAV: NavItem[] = [
  { id: "now", label: "What's new", num: "01", href: "/" },
  { id: "been", label: "Where we've been", num: "02", href: "/been" },
  { id: "are", label: "Where we are", num: "03", href: "/are" },
  { id: "going", label: "Where we're going", num: "04", href: "/going" },
  { id: "calendar", label: "Content Calendar", num: "05", href: "/calendar" },
  { id: "library", label: "Content Library", num: "06", href: "/library" },
  { id: "toolkit", label: "Your Toolkit", num: "07", href: "/toolkit" }
];
...
export const MONTHS: Record<string, MonthRecord> = {
  July: {
...
export const HORIZONS: Record<HorizonKey, Horizon> = {
  "30 Days": {
...
export const IN_MOTION: InMotionItem[] = [
...
export const TYPE_COLOR: Record<string, string> = { Reel: "#6C1E27", Carousel: "#A06D28", Story: "#2E2622", Feed: "#6F7355" };
export const STATUS_COLOR: Record<string, string> = { Scheduled: "#6F7355", "In review": "#A06D28", "Shoot locked": "#6C1E27", "In Planable": "#8B7F73" };
...
export const GANTT_COLOR: Record<string, string> = { campaign: "#6C1E27", shoot: "#A06D28", system: "#6F7355" };
